                            ...
                            <div class="content-box">
                                <div class="upper clearfix">
                                    ...
                                    <ul class="social-list pull-right clearfix">
                                        <li><a href="agency-details.php"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="agency-details.php"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="agency-details.php"><i class="fab fa-linkedin-in"></i></a></li>
                                    </ul>
                                </div>
                                <div class="text">
                                                ...
                                                <div class="inner-box">
                                                    ...
                                                    <div class="lower-content">
                                                        ...
                                                        <div class="other-info-box clearfix">
                                                            <div class="btn-box pull-left"><a href="property-details.php" class="theme-btn btn-two">See Details</a></div>
                                                    ...
                                                    <div class="feature-block-one">
                                                        <div class="inner-box">
                                                            ...
                                                            <div class="lower-content">
                                                                ...
                                                                <div class="title-text"><h4><a href="property-details.php">The Citizen Apartment</a></h4></div>
                                                                <div class="price-box clearfix">
                                                                    <div class="price-info pull-left">
                                                                        <h6>Start From</h6>
                                                                        <h4>$45,000.00</h4>
                                                    ...
                                                    <div class="feature-block-one">
                                                        <div class="inner-box">
                                                            ...
                                                            <div class="lower-content">
                                                                ...
                                                                <div class="title-text"><h4><a href="property-details.php">Cottage Woods House</a></h4></div>
                                                                <div class="price-box clearfix">
                                                                    <div class="price-info pull-left">
                                                                        <h6>Start From</h6>
                                                                        <h4>$63,000.00</h4>
                        ...
                        <div class="default-sidebar agent-sidebar">
                            <div class="agents-contact sidebar-widget">
                                ...
                                <div class="form-inner">
                                    <form action="contact.php" method="post" class="default-form">
