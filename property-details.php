...
$sql = "SELECT properties.*, users.name, users.email, users.user_img, users.phone, users.occupation, 
        users.facebook_link, users.twitter_link, users.linkedin_link, users.user_description,users.house,users.street 
        FROM properties 
...
if ($result->num_rows > 0) {
    ...
    $property_status = $property['property_now_status'];
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var fullAddress = "<?php echo  $country . ', ' . $state_county . ', ' . $city . ', ' . $zip_postal_code; ?>";
                                    ...
                                    <div class="lower-content">
                                        <div class="author-info clearfix">
                                            ...
                                            <div class="buy-btn pull-right"><a
                                                    href="property-details.php?id=<?= $row['id']; ?>">For Buy</a></div>
                                        </div>
                                        <div class="title-text">
                                            <h4><a
                                                    href="property-details.php?id=<?= $row['id']; ?>"><?= $row['property_name']; ?></a>
                                            </h4>
                                        </div>
                                        ...
                                        <div class="btn-box">
                                            <a href="property-details.php?id=<?= $row['id']; ?>" class="theme-btn btn-two">See
                                                Details</a>
                                        </div>
                                    </div>
                                </div>
