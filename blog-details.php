            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
              ...
              FROM `blogs` WHERE `id` = $blog_id";
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/blogs/<?php echo $image; ?>" alt="">
                                </figure>
                                <?php if ($featured == 1): ?>
                                ...
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img
                                                src="assets/images/agents/<?php echo $author_image; ?>" alt=""></figure>
                                ...
                                <div class="post-tags">
                                    <ul class="tags-list clearfix">
                                        ...
                                        <?php foreach ($tags as $tag): ?>
                                            <li><a
                                                    href="blog-details.php?tag=<?php echo urlencode(trim($tag)); ?>"><?php echo htmlspecialchars(trim($tag)); ?></a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="assets/images/news/<?php echo $row['user_image'] ?: 'default.jpg'; ?>"
                                                alt="">
                                        </figure>
