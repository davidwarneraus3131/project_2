        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.php"><img src="assets/images/logo-light.png" alt=""></a></figure>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current dropdown"><a href="index.php"><span>Home</span></a>
                                            
                                        </li>
                                       
                                        <li class="dropdown"><a href="index.php"><span>Property</span></a>
                                            <ul>
                                        ...
                                        <!-- <li class="dropdown"><a href="index.php"><span>Pages</span></a>
                                            <div class="megamenu">
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="assets/images/property/<?php echo $property_img ?>" alt=""></figure>
                                        <h6><?php  echo $agent_name?></h6>
                                    </div>
                                    <div class="buy-btn pull-right"><a href="property-details.php">For Buy</a></div>
                                </div>
                                <div class="title-text"><h4><a href="agents-details.php"><?php echo $property_name ?></a></h4></div>
        ...
        <section class="cta-section alternate-2 centred" style="background-image: url(assets/images/background/cta-1.jpg);">
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box">
                        <a href="property-details.php" class="theme-btn btn-three">Rent Properties</a>
                        <a href="index.php" class="theme-btn btn-one">Buy Properties</a>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            ...
                                            <div class="other-info-box clearfix">
                                                <div class="btn-box pull-left"><a href="property-details.php" class="theme-btn btn-one">See Details</a></div>
                                                <ul class="other-option pull-right clearfix">
                                                    <li><a href="property-details.php"><i class="icon-12"></i></a></li>
                                                    <li><a href="property-details.php"><i class="icon-13"></i></a></li>
                                                </ul>
        ...
        <section class="chooseus-section alternate-2 bg-color-1">
            <div class="auto-container">
                <div class="upper-box clearfix">
                    ...
                    <div class="btn-box">
                        <a href="categories.php" class="theme-btn btn-one">All Categories</a>
                    </div>
                </div>
                <div class="lower-box">
                    <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        <h4><a href="agents-details.php">Jennifer Lawrence</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        <h4><a href="agents-details.php">Benedict Cumberbatch</a></h4>
                                        <span class="designation">Senior Agent</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        <h4><a href="agents-details.php">Elizabeth Winstead</a></h4>
                                        <span class="designation">Senior Agent</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="content_block_2">
                            <div class="content-box">
                                ...
                                <ul class="place-list clearfix">
                                    <li><a href="categories.php"><h5>Australia</h5><span>(02)</span></a></li>
                                    <li><a href="categories.php"><h5>Bangladesh</h5><span>(13)</span></a></li>
                                    <li><a href="categories.php"><h5>Belgium</h5><span>(05)</span></a></li>
                                    <li><a href="categories.php"><h5>Brazil</h5><span>(04)</span></a></li>
                                    <li><a href="categories.php"><h5>California</h5><span>(07)</span></a></li>
                                </ul>
                                <div class="btn-box">
                                    <a href="categories.php" class="theme-btn btn-one">View All Places</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 inner-column">
                        <div class="clients-logo">
                            <ul class="logo-list clearfix">
                                <li>
                                    <figure class="logo"><a href="index-2.php"><img src="assets/images/clients/clients-1.png" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.php"><img src="assets/images/clients/clients-2.png" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.php"><img src="assets/images/clients/clients-3.png" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.php"><img src="assets/images/clients/clients-4.png" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.php"><img src="assets/images/clients/clients-5.png" alt=""></a></figure>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            ...
                                            <h5><a href="blog-details.php">Eva Green</a></h5>
                                        </li>
                                        <li>April 10, 2020</li>
                                    </ul>
                                    <div class="text">
                                    ...
                                    <div class="btn-box">
                                        <a href="blog-details.php" class="theme-btn btn-two">See Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            ...
                                            <h5><a href="blog-details.php">George Clooney</a></h5>
                                        </li>
                                        <li>April 09, 2020</li>
                                    </ul>
                                    <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h4><a href="blog-details.php">How New Font Technologies Will Improve The Web</a></h4>
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="assets/images/news/author-3.jpg" alt=""></figure>
                                            <h5><a href="blog-details.php">Simon Baker</a></h5>
                                        </li>
                                        <li>April 28, 2020</li>
                                    </ul>
                                    <div class="text">
